...
To roll out and ensure the successful adoption of Microsoft Search in Bing across your organization, we recommend this four-stage process.
  
## Stage 1: Stakeholders

To ensure a seamless rollout and increase user adoption of Microsoft Search in Bing, identify people who can help support and drive the process.
...
|:-----|:-----|:-----|
|Executive sponsor  <br/> |Understand the high-level vision and value of Microsoft Search in Bing for your organization  <br/> Provide leadership support to IT/business team  <br/> Allocate resources  <br/> Communicate directly with the employees  <br/> |Executive leadership  <br/> |
...
|Search administrator  <br/> |Identify user adoption core team members  <br/> Administrate Microsoft Search in Bing, including look and feel of the experience and ongoing management  <br/> Drive discussions to show the value of Microsoft Search in Bing  <br/> |IT  <br/> |
|Editors  <br/> |Create content in the Admin portal  <br/> |IT/Any  <br/> |
   
## Stage 2: Scenarios

To ensure user adoption, it's critical to determine and define end-user scenarios. These should include real-world examples of how people can use Microsoft Search in Bing to find the information they need, answer questions, and complete tasks faster. In order to measure the success of your roll out and user adoption, it's also important to determine the metrics you'll use before you begin.
  
 **Understand what your users need and want**
  
When it comes to finding information and getting answers, knowing your user's needs and pain points is key. You can use quantitative methods, like data from Office 365 and SharePoint search usage, or qualitative methods, like surveys and user focus groups to get this data. This will help you determine when, where, and how Microsoft Search in Bing can provide value.
...
- How the benefits of Microsoft Search in Bing apply to your organization. For more information see [Why Microsoft Search in Bing.](overview/why-microsoft-search.md)
...
1. **Change management:** Determine how you'll measure awareness of Microsoft Search in Bing and the success of communications about it. 
    
2. **Usage:** You can leverage data from your Insights Dashboard including daily and monthly active users (DAU and MAU), the content types that are getting the most views, and top search keywords to measure usage over time. For more information, see [Using the Insights Dashboard](get-insights.md).
...
Administrators directly influence the search experience for end users and determine how Microsoft Search in Bing looks for the organization. This includes choosing the types of results you want to surface to your users. Control this by turning on or off results for documents, sites, people, groups, or conversations.
...
- Ensure Azure Active directory configurations are correctly set, have a few users try to sign in. For more information, see [Testing single sign-on](setup/test-single-sign-on.md).
    
- Set browser defaults for company-managed devices to Bing. For more information, see [Default Windows settings for Microsoft Search in Bing users](https://support.office.com/article/43f28f94-0233-475d-977b-f172613a4e5d.aspx).
...
Use your real-world scenarios to tell users about Microsoft Search in Bing and how it will help them save time. Your change management team can help create a rollout strategy and prepare collateral and campaigns for end-user readiness.
...
- Share self-help documentation about using Microsoft Search in Bing
    
All communications should educate users about how they can sign in to Bing to find work results.
  
 **Engage partner teams**
  
As an integral part of Microsoft 365, Microsoft Search in Bing complies with GDPR and Tier-C guidelines. Depending on your organization, it may be necessary to share information about Microsoft Search in Bing with your privacy and security teams. For more information, see [Security for Microsoft Search in Bing](overview/security.md).
  
Make sure your help desk knows about the features and functionality of Microsoft Search in Bing, as well as the user requirements to sign in, so they can more effectively support users. For more information, see [Using Microsoft Search in Bing ](use/use-microsoft-search.md)and [FAQs](faqs.md).
  
 **Evaluate with pilot users**
  
Start with a small group of users to evaluate the impact of Microsoft Search in Bing and gather early feedback. This gives you time to change content, update your communications, and set expectations for the broad rollout. Search power users or early adopters are great candidates for this.
...
Ask your pilot users to provide input using the feedback options in Microsoft Search in Bing or via simple surveys.
  
Survey questions to ask: 
  
- Do you understand how to sign in and use Microsoft Search in Bing?
...
- Are the communications about Microsoft Search in Bing clear and understandable?
    
This is a great time to begin measuring the effectiveness of the metrics identified in Stage 2.
  
When you start the pilot phase, consider sharing a sneak peek of Microsoft Search in Bing with the wider organization.
...
When you are ready, either allow all users in your organization access to Microsoft Search in Bing, or use a phased approach to roll out more slowly. 
  
 **Generate awareness**
  
Build excitement in your organization about Microsoft Search in Bing:
...
For the first few weeks and months, maintain a rhythm of communications to encourage engagement with Microsoft Search in Bing. This keeps users informed and engages new users. Each communication should explain why Microsoft Search in Bing can be helpful to their work.
...
3. Conduct surveys, focus groups, and feedback sessions to understand what users think of Microsoft Search in Bing, increase adoption, and identify improvement areas
    
Education and feedback is an iterative process. It may be necessary to make changes to content and communications as your users adopt Microsoft Search in Bing. 
  
## See also

[Explore Microsoft Search in Bing](https://go.microsoft.com/fwlink/?linkid=2017806)
  
[Why Microsoft Search in Bing](overview/why-microsoft-search.md)
