...
You must be the admin for your organization's Microsoft 365 tenant and the admin for your organization's Azure DevOps instance.
...
(Follow the general [setup instructions](./configure-connector.md) for more details)
