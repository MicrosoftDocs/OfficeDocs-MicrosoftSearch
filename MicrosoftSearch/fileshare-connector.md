...
Rules for writing regular expression can be found [here](https://docs.microsoft.com/en-us/dotnet/standard/base-types/regular-expression-language-quick-reference)
