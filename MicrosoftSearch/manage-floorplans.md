...
2. Select a building in the drop-down list and select **Next**. If the building isn't listed, [go back and add the Location](#Step-5:-Add-building-locations).
...
|Link office locations|No office locations found in AAD. Add location data to AAD before setting up floor plans.|Error|[Update office locations in user profiles](#Step-3:-Update-office-locations-on-user-profiles) |
