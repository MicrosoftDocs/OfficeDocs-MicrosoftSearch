...
|:-----|:-----|
|Microsoft Search for Bing |The work tab in Microsoft Search in Bing.   |
...
|Windows Search Work results |Queries with work results from the Windows Search Bar.   |
|Outlook |Queries in Outlook.|
|Teams |Queries in Teams|
|OneDrive |Queries in OneDrive |
|Word, Excel, PowerPoint |Aggregate of queries in Word, Excel and PowerPoint.    |
...
Downloading a report will allow you to see reports from a broader range of time. The report is downloaded as an Excel spreadsheet based on the selected date filter. If you chose the past 7, 14, or 28 days, the spreadsheet would have an individual tab for each day. The past 12 months download will have a tab for each month.
