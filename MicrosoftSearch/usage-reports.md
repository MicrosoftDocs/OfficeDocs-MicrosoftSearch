...
:::image type="content" source="media/usage-reports/usage-reports-v3.png" alt-text="A report dashboard that shows graphs and tables of search usage." lightbox="media/usage-reports/usage-reports-v3.png":::
