...
You can select a non-Azure AD user property from the dropdown and provide a regular expression to be applied on those user property values. To learn more about regular expressions, see [here](../dotnet/docs/docs/standard/base-types/regular-expression-language-quick-reference)
