...
Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items per licensed user (pooled at the tenant level) using Microsoft Graph connectors for Microsoft Search. Note: This is not included with A5.
