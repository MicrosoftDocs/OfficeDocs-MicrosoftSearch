...
To learn more about connecting to an on-premises data source, see [Setup Graph Connector Agent](/microsoftsearch/graph-connector-agent).
...
> [!NOTE]
> Incrementals crawls do not support processing of updates to **permissions** currently.
